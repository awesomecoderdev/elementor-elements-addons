...
class Options extends Base {
	...
	/**
	 * Can a user link another AwesomeCoder account in a setup?.
	 * @return boolean
	 */
	...
	public function is_global(){
		return intval( get_option('_eea_global_login', 0) );
	}
	...
	public static function set_global_login() {
		return update_option('_eea_global_login', get_current_user_id(), 'no');
	}
	/**
	...
	public function remove_global_login() {
		return delete_option( '_eea_global_login' );
	}
