...
use AwesomeCoder\Container\BoundMethod;
use AwesomeCoder\Exception\EntryNotFoundException;
use AwesomeCoder\Exception\BindingResolutionException;
use AwesomeCoder\Exception\CircularDependencyException;
...
class Container implements ArrayAccess, ContainerContract
{
     ...
     *
     * @throws \AwesomeCoder\Exception\BindingResolutionException
     * @throws \AwesomeCoder\Exception\CircularDependencyException
     */
