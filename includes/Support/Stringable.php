...
class Stringable implements JsonSerializable, ArrayAccess
{
    ...
    {
        return new static(static::class_basename($this->value));
    }
     ...
     * @param  int  $limit
     * @return \AwesomeCoder\Support\Collection<int, string>
     */
    ...
    {
        $tz = is_null($tz) ? get_option('timezone_string') : $tz;
        $tz = !empty($tz) ? $tz : 'UTC';
        date_default_timezone_set($tz); // Change to your desired time zone
